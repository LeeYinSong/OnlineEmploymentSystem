...
<div class="p-5 mr-1 container">
    <div class="row" style="justify-content: flex-center; position: relative">
        <div class="col-md-5">
            <div class="card">
                <div class="card-header"  style ="text-align:center; font-family:verdana;"><img src="{{ asset('images/LoginLg.png')}}" alt="" class="img-fluid" width=10%;>Insert Education</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('addEducation.store') }}">
                        @csrf
                        ...
                        <div class="col-md-8">
                            <input type="text" name="name" id="name" class="form-control" placeholder="Please Enter Education Name......">
