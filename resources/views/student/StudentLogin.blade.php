@extends('student.navBar.LoginNav')
<style>
    body.background {
...
<div class="p-5 mr-1 container">
    <div class="row" style="justify-content: flex-end; position: relative">
        <div class="col-md-5">
            <div class="card">
                <div class="card-header"  style ="text-align:center; font-family:verdana;"><img src="{{ asset('images/LoginLg.png')}}" alt="" class="img-fluid" width=10%;>Student {{ __('Login') }}</div>
